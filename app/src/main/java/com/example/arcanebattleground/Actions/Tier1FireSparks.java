...
public class Tier1FireSparks extends SimpleAttackSpell {
    public Tier1FireSparks() {
        super("Fire Sparks", 6, 2, 9, Bitmap.createScaledBitmap(Bitmap.createBitmap(GameView.oldSpriteSheet, 0, 0, 32, 32), (int)(screenWidth*0.225), (int)(screenWidth*0.225), false));
    }
}
